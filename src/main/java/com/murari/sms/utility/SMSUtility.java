package com.murari.sms.utility;
 ...
 * @author kiran
 * 
 *         1) You have to register at Way2SMS and Obtain a User Name and
 *         Password.
 * 
 *         2)You have to find the ACTION value.
 * 
 *         In-order to find the action value first install 'fire bug' to your
 *         Firefox. Then login to your way2sms account. Open Firebug from
 *         tools->Firebug->open firebug. In the search field of firebug type
 *         'action' and click next until you find something like
 *         <input id="Action" type="hidden" value="sa65sdf656fdfd" name=
 *         "Action">
 * 
 *         Now the value 'sa65sdf656fdfd' is your ACTION value.
 * 
 * 
 *        edit the following fields in main() USERNAME
 *         : Your way2sms username PASSWORD : Your way2sms password ACTION : The
 *         ACTION value we found out Also uncomment the proxy support if needed.
 */
public class SMSUtility {
	...
	public static void sendSms(String args[]) {
		...
		sms.loginWay2SMS(USERNAME, PASSWORD);
